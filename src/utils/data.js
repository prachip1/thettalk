...
export const userQuery =(sub)=>{
    const query = `*[_type == "user" ]`; //sanity query check docs
...
//userId is replaced with sub cause google api write userId as sub
...
//userId is replaced with sub cause google api write _id as sub
